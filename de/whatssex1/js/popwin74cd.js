var Popwin = {
    ...
    links: {
        terms: {
            selector: '#pluginRegTermsLink, .legal__agb',
            url: null
        },
        privacy: {
            selector: '#pluginRegPrivacyLink, .legal__privacy',
            url: null
        },
        imprint: {
            selector: '.imprintLink, .legal__imprint',
            url: null
        },
        entertainment: {
            selector: '.entertainmentPolicy, .legal__entertainment',
            url: null
        }
    },
    initialize: function() {
