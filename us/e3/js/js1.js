...
$(document).ready(function() {
    ...
    var countdown = 12 * 60 * 1000;
    var timerId = setInterval(function() {
        countdown -= 1000;
        var minutes = " minutes and ";
        ...
        if (countdown <= 0) {
            ...
            if (sec <= 9) {
                $(".timer").html(min + minutes + "0" + sec + ' seconds...');
            } else {
    ...
    function stepByStep(showElem, delay, func) {
        var counter = 0;
        var elemLength = showElem.children().length;
        var showOneByOne = setInterval(function() {
            showElem.children().eq(counter).fadeIn();
            counter++;
            if (counter > elemLength) {
                if (func) {
                    func();
                }
                clearInterval(showOneByOne);
            }
        }, delay);
    }
    ...
    function lastStep() {
        $(".step").hide();
        $(".final_step").fadeIn();
        stepByStep($(".final_step"), 200, scrollPage);
    };
    ...
    scrollPage();
    changeSlider();
    $('.members_online').text(randomText(50, 300));
    $(".members").text(randomText(50, 3000));
    ...
    $(".yes_btn, .no_btn").click(function() {
        ...
        if (currentQ == questionCount) {
            ...
            stepByStep($(".loading_block"), 1000, lastStep);
        }
        scrollPage();
    });
