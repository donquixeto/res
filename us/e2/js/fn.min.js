function remClass() {
    $("body").removeClass("clckStg_01 clckStg_02 clckStg_03 clckStg_04 clckStg_05  clckStg_06 clckStg_07 clckStg_08 clckStg_09 clckStg_10 clckStg_11 clckStg_12")
}! function(e, t) {
    "use strict";
    ...
    function l() {
        Z.removeEventListener("DOMContentLoaded", l), e.removeEventListener("load", l), de.ready()
    }
    ...
    function d(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (r = "data-" + t.replace($e, "-$&").toLowerCase(), n = e.getAttribute(r), "string" == typeof n) {
                try {
                    n = "true" === n || "false" !== n && ("null" === n ? null : +n + "" === n ? +n : He.test(n) ? JSON.parse(n) : n)
                } catch (e) {}
                qe.set(e, t, n)
            } else n = void 0;
        return n
    ...
    function p(e, t, n, r) {
        var i, o = 1,
            ...
            l = (de.cssNumber[t] || "px" !== c && +u) && Pe.exec(de.css(e, t));
        if (l && l[3] !== c) {
            c = c || l[3], n = n || [], l = +u || 1;
            do o = o || ".5", l /= o, de.style(e, t, l + c); while (o !== (o = s() / u) && 1 !== o && --a)
        }
    ...
    function h(e) {
        var t, n = e.ownerDocument,
            r = e.nodeName,
            i = We[r];
        return i ? i : (t = n.body.appendChild(n.createElement(r)), i = de.css(t, "display"), t.parentNode.removeChild(t), "none" === i && (i = "block"), We[r] = i, i)
    }

    function g(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++) r = e[o], r.style && (n = r.style.display, t ? ("none" === n && (i[o] = Oe.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && Ie(r) && (i[o] = h(r))) : "none" !== n && (i[o] = "none", Oe.set(r, "display", n)));
    ...
    function y(e, t, n, r, i) {
        for (var o, a, s, u, c, l, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++)
            ...
            for (a = a || f.appendChild(t.createElement("div")), s = (ze.exec(o) || ["", ""])[1].toLowerCase(), u = Xe[s] || Xe._default, a.innerHTML = u[1] + de.htmlPrefilter(o) + u[2], l = u[0]; l--;) a = a.lastChild;
            de.merge(d, a.childNodes), a = f.firstChild, a.textContent = ""
        } else d.push(t.createTextNode(o));
        for (f.textContent = "", p = 0; o = d[p++];)
            if (r && de.inArray(o, r) > -1) i && i.push(o);
            else if (c = de.contains(o.ownerDocument, o), a = m(f.appendChild(o), "script"), c && v(a), n)
    ...
    function A(e, t) {
        var n, r, i, o, a, s, u, c;
        if (1 === t.nodeType) {
            if (Oe.hasData(e) && (o = Oe.access(e), a = Oe.set(t, o), c = o.events)) {
                delete a.handle, a.events = {};
                for (i in c)
                    for (n = 0, r = c[i].length; n < r; n++) de.event.add(t, i, c[i][n])
            }
    ...
    function N(e, t, r, i) {
        ...
        var o, a, s, u, c, l, f = 0,
            ...
            h = t[0],
            g = de.isFunction(h);
        if (g || d > 1 && "string" == typeof h && !le.checkClone && et.test(h)) return e.each(function(n) {
            var o = e.eq(n);
            g && (t[0] = h.call(this, n, o.html())), N(o, t, r, i)
        });
        if (d && (o = y(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
            for (s = de.map(m(o, "script"), k), u = s.length; f < d; f++) c = o, f !== p && (c = de.clone(c, !0, !0), u && de.merge(s, m(c, "script"))), r.call(e[f], c, f);
            if (u)
                for (l = s[s.length - 1].ownerDocument, de.map(s, S), f = 0; f < u; f++) c = s[f], Ue.test(c.type || "") && !Oe.access(c, "globalEval") && de.contains(l, c) && (c.src ? de._evalUrl && de._evalUrl(c.src) : n(c.textContent.replace(nt, ""), l))
        }
        return e
    }

    function D(e, t, n) {
        for (var r, i = t ? de.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || de.cleanData(m(r)), r.parentNode && (n && de.contains(r.ownerDocument, r) && v(m(r, "script")), r.parentNode.removeChild(r));
        return e
    }

    function L(e, t, n) {
        var r, i, o, a, s = e.style;
        return n = n || ot(e), n && (a = n.getPropertyValue(t) || n[t], "" !== a || de.contains(e.ownerDocument, e) || (a = de.style(e, t)), !le.pixelMarginRight() && it.test(a) && rt.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    function q(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2) "margin" === n && (a += de.css(e, n + Re[o], !0, i)), r ? ("content" === n && (a -= de.css(e, "padding" + Re[o], !0, i)), "margin" !== n && (a -= de.css(e, "border" + Re[o] + "Width", !0, i))) : (a += de.css(e, "padding" + Re[o], !0, i), "padding" !== n && (a += de.css(e, "border" + Re[o] + "Width", !0, i)));
        return a
    }
    ...
    function H(e, t, n) {
        ...
        if (e.getClientRects().length && (r = e.getBoundingClientRect()[t]), r <= 0 || null == r) {
            if (r = L(e, t, o), (r < 0 || null == r) && (r = e.style[t]), it.test(r)) return r;
            i = a && (le.boxSizingReliable() || r === e.style[t]), r = parseFloat(r) || 0
        }
    ...
    function F() {
        dt && (e.requestAnimationFrame(F), de.fx.tick())
    }
    ...
    function M(e, t, n) {
        ...
        if (u = !de.isEmptyObject(t), u || !de.isEmptyObject(p)) {
            f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], c = v && v.display, null == c && (c = Oe.get(e, "display")), l = de.css(e, "display"), "none" === l && (c ? l = c : (g([e], !0), c = e.style.display || c, l = de.css(e, "display"), g([e]))), ("inline" === l || "inline-block" === l && null != c) && "none" === de.css(e, "float") && (u || (d.done(function() {
                h.display = c
            }), null == c && (l = h.display, c = "none" === l ? "" : l)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", d.always(function() {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            })), u = !1;
            for (r in p) u || (v ? "hidden" in v && (m = v.hidden) : v = Oe.access(e, "fxshow", {
                display: c
            }), o && (v.hidden = !m), m && g([e], !0), d.done(function() {
                m || g([e]), Oe.remove(e, "fxshow");
                for (r in p) de.style(e, r, p[r])
            })), u = I(m ? v[r] : 0, r, d), r in v || (v[r] = u.start, m && (u.end = u.start, u.start = 0))
        }
    }
    ...
    function W(e, t) {
        var n, r, i, o, a;
        for (n in e)
            if (r = de.camelCase(n), i = t[r], o = e[n], de.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), a = de.cssHooks[r], a && "expand" in a) {
    ...
    function B(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = ft || P(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, a = 0, u = c.tweens.length; a < u; a++) c.tweens[a].run(o);
            ...
            l = c.props;
        for (W(l, c.opts.specialEasing); o < a; o++)
            if (r = B.prefilters[o].call(c, e, l, c.opts)) return de.isFunction(r.stop) && (de._queueHooks(c.elem, c.opts.queue).stop = de.proxy(r.stop, r)), r;
        return de.map(l, I, c), de.isFunction(c.opts.start) && c.opts.start.call(e, c), de.fx.timer(de.extend(u, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    de.fn = de.prototype = {
        ...
        for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || de.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++)
            if (null != (e = arguments[s]))
                for (t in e) n = a[t], r = e[t], a !== r && (c && r && (de.isPlainObject(r) || (i = de.isArray(r))) ? (i ? (i = !1, o = n && de.isArray(n) ? n : []) : o = n && de.isPlainObject(n) ? n : {}, a[t] = de.extend(c, o, r)) : void 0 !== r && (a[t] = r));
        return a
    }, de.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== ae.call(e) || (t = ee(e)) && (n = se.call(t, "constructor") && t.constructor, "function" != typeof n || ue.call(n) !== ce))
        },
        ...
        proxy: function(e, t) {
            var n, r, i;
            if ("string" == typeof t && (n = e[t], t = e, e = n), de.isFunction(e)) return r = te.call(arguments, 2), i = function() {
                return e.apply(t || this, r.concat(te.call(arguments)))
            }, i.guid = e.guid = e.guid || de.guid++, i
        },
        now: Date.now,
        support: le
    }), "function" == typeof Symbol && (de.fn[Symbol.iterator] = K[Symbol.iterator]), de.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function(e, t) {
    ...
    var ve = function(e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : M) !== O && _(t), t = t || O, H)) {
                if (11 !== h && (u = ve.exec(e)))
                    if (i = u[1]) {
                        if (9 === h) {
                ...
                if (C.qsa && !X[e + " "] && (!$ || !$.test(e))) {
                    if (1 !== h) d = t, l = e;
                        ...
                        for ((s = t.getAttribute("id")) ? s = s.replace(we, Ce) : t.setAttribute("id", s = I), c = A(e), o = c.length; o--;) c[o] = "#" + s + " " + p(c[o]);
        ...
        function y(e, t, n, i, o, a) {
            return i && !i[I] && (i = y(i)), o && !o[I] && (o = y(o, a)), r(function(r, a, s, u) {
                var c, l, f, d = [],
                    p = [],
                    h = a.length,
                    ...
                    x = n ? o || (r ? e : h || i) ? [] : a : y;
                if (n && n(y, x, s, u), i)
                    for (c = v(x, p), i(c, [], s, u), l = c.length; l--;)(f = c[l]) && (x[p[l]] = !(y[p[l]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (l = x.length; l--;)(f = x[l]) && (c = o ? ee(r, f) : d[l]) > -1 && (r[c] = !(a[c] = f))
                    }
            ...
            var i = n.length > 0,
                ...
                a = function(r, a, s, u, c) {
                    var l, f, d, p = 0,
                        ...
                        w = x.length;
                    for (c && (D = a === O || a || c); h !== w && null != (l = x[h]); h++) {
                        if (o && l) {
                            for (f = 0, a || l.ownerDocument === O || (_(l), s = !H); d = e[f++];)
                                if (d(l, a || O, s)) {
                                    u.push(l);
                                    break
                                }
        ...
        var w, C, T, k, S, A, E, N, D, L, j, _, O, q, H, $, F, P, R, I = "sizzle" + 1 * new Date,
            M = e.document,
            W = 0,
            B = 0,
            z = n(),
        ...
        C = t.support = {}, S = t.isXML = function(e) {
            ...
            return r !== O && 9 === r.nodeType && r.documentElement ? (O = r, q = O.documentElement, H = !S(O), M !== O && (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), C.attributes = i(function(e) {
            ...
            }, F = [], $ = [], (C.qsa = me.test(O.querySelectorAll)) && (i(function(e) {
                ...
                t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && $.push("name" + ne + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && $.push(":enabled", ":disabled"), q.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && $.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), $.push(",.*:")
            })), (C.matchesSelector = me.test(P = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && i(function(e) {
                C.disconnectedMatch = P.call(e, "*"), P.call(e, "[s!='']:x"), F.push("!=", oe)
            }), $ = $.length && new RegExp($.join("|")), F = F.length && new RegExp(F.join("|")), t = me.test(q.compareDocumentPosition), R = t || me.test(q.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !C.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === M && R(M, e) ? -1 : t === O || t.ownerDocument === M && R(M, t) ? 1 : L ? ee(L, e) - ee(L, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return j = !0, 0;
                var n, r = 0,
                    i = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== O && _(e), n = n.replace(le, "='$1']"), C.matchesSelector && H && !X[n + " "] && (!F || !F.test(n)) && (!$ || !$.test(n))) try {
                var r = P.call(e, n);
                if (r || C.disconnectedMatch || e.document && 11 !== e.document.nodeType) return r
            } catch (e) {}
            return t(n, O, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== O && _(e), R(e, t)
        }, t.attr = function(e, t) {
            (e.ownerDocument || e) !== O && _(e);
            var n = T.attrHandle[t.toLowerCase()],
                r = n && Q.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0;
            ...
            var t, n = [],
                r = 0,
                i = 0;
            if (j = !C.detectDuplicates, L = !C.sortStable && e.slice(0), e.sort(V), j) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                for (d = m, f = d[I] || (d[I] = {}), l = f[d.uniqueID] || (f[d.uniqueID] = {}), c = l[e] || [], p = c[0] === W && c[1], x = p && c[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (x = p = 0) || h.pop();)
                                    if (1 === d.nodeType && ++x && d === t) {
                                        l[e] = [W, p, x];
                                        break
                                    }
                            } else if (y && (d = t, f = d[I] || (d[I] = {}), l = f[d.uniqueID] || (f[d.uniqueID] = {}), c = l[e] || [], p = c[0] === W && c[1], x = p), x === !1)
                                for (;
                                    (d = ++p && d && d[g] || (x = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++x || (y && (f = d[I] || (d[I] = {}), l = f[d.uniqueID] || (f[d.uniqueID] = {}), l[e] = [W, x]), d !== t)););
        ...
        return d.prototype = T.filters = T.pseudos, T.setFilters = new d, A = t.tokenize = function(e, n) {
            ...
            var n, r = [],
                ...
                o = X[e + " "];
            if (!o) {
                for (t || (t = A(e)), n = t.length; n--;) o = x(t[n]), o[I] ? r.push(o) : i.push(o);
            ...
            if (n = n || [], 1 === l.length) {
                if (o = l[0] = l[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && C.getById && 9 === t.nodeType && H && T.relative[o[1].type]) {
                    if (t = (T.find.ID(a.matches[0].replace(xe, be), t) || [])[0], !t) return n;
                    c && (t = t.parentNode), e = e.slice(o.shift().value.length)
                }
                for (i = pe.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !T.relative[s = a.type]);)
                    if ((u = T.find[s]) && (r = u(a.matches[0].replace(xe, be), ye.test(o[0].type) && f(t.parentNode) || t))) {
                        if (o.splice(i, 1), e = r.length && p(o), !e) return K.apply(n, r), n;
                        break
                    }
            }
            return (c || E(e, l))(r, t, !H, n, !t || ye.test(e) && f(t.parentNode) || t), n
        }, C.sortStable = I.split("").sort(V).join("") === I, C.detectDuplicates = !!j, _(), C.sortDetached = i(function(e) {
    ...
    de.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!i(this, "string" == typeof e && be.test(e) ? de(e) : e || [], !1).length
        }
    });
    var Te, ke = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
        Se = de.fn.init = function(e, t, n) {
            ...
            if (n = n || Te, "string" == typeof e) {
                ...
                if (r[1]) {
                    if (t = t instanceof de ? t[0] : t, de.merge(this, de.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : Z, !0)), we.test(r[1]) && de.isPlainObject(t))
    ...
    de.fn.extend({
        ...
        de.fn[e] = function(n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = de.filter(r, i)), this.length > 1 && (Ee[e] || de.uniqueSort(i), Ae.test(e) && i.reverse()), this.pushStack(i)
        }
    });
    var Ne = /\S+/g;
    de.Callbacks = function(e) {
                ...
                add: function() {
                    return o && (n && !t && (u = o.length - 1, s.push(n)), function t(n) {
                        de.each(n, function(n, r) {
                            de.isFunction(r) ? e.unique && l.has(r) || o.push(r) : r && r.length && "string" !== de.type(r) && t(r)
                        })
                                ...
                                var c = this,
                                    ...
                                    d = i ? f : function() {
                                        try {
                                            ...
                                            de.Deferred.exceptionHook && de.Deferred.exceptionHook(e, d.stackTrace), t + 1 >= a && (r !== u && (c = void 0, l = [e]), n.rejectWith(c, l))
                                        }
                                    };
        ...
        when: function(e) {
            ...
            if (t <= 1 && (c(e, o.done(a(n)).resolve, o.reject), "pending" === o.state() || de.isFunction(i[n] && i[n].then))) return o.then();
    ...
    de.fn.ready = function(e) {
        ...
        ready: function(e) {
            (e === !0 ? --de.readyWait : de.isReady) || (de.isReady = !0, e !== !0 && --de.readyWait > 0 || Le.resolveWith(Z, [de]))
        }
    }), de.ready.then = Le.then, "complete" === Z.readyState || "loading" !== Z.readyState && !Z.documentElement.doScroll ? e.setTimeout(de.ready) : (Z.addEventListener("DOMContentLoaded", l), e.addEventListener("load", l));
    ...
    de.extend({
        ...
        data: function(e, t) {
            var n, r, i, o = this[0],
                a = o && o.attributes;
            if (void 0 === e) {
                if (this.length && (i = qe.get(o), 1 === o.nodeType && !Oe.get(o, "hasDataAttrs"))) {
        ...
        queue: function(e, t, n) {
            var r;
            if (e) return t = (t || "fx") + "queue", r = Oe.get(e, t), n && (!r || de.isArray(n) ? r = Oe.access(e, t, de.makeArray(n)) : r.push(n)), r || []
        },
    ...
    de.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, u, c, l, f, d, p, h, g, m = Oe.get(e);
            if (m)
                for (n.handler && (o = n, n = o.handler, i = o.selector), i && de.find.matchesSelector(Qe, i), n.guid || (n.guid = de.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
                        return "undefined" != typeof de && de.event.triggered !== t.type ? de.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(Ne) || [""], c = t.length; c--;) s = Je.exec(t[c]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p && (f = de.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = de.event.special[p] || {}, l = de.extend({
                    type: p,
                    origType: g,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (d = u[p]) || (d = u[p] = [], d.delegateCount = 0, f.setup && f.setup.call(e, r, h, a) !== !1 || e.addEventListener && e.addEventListener(p, a)), f.add && (f.add.call(e, l), l.handler.guid || (l.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, l) : d.push(l), de.event.global[p] = !0)
        },
        remove: function(e, t, n, r, i) {
            var o, a, s, u, c, l, f, d, p, h, g, m = Oe.hasData(e) && Oe.get(e);
            if (m && (u = m.events)) {
                for (t = (t || "").match(Ne) || [""], c = t.length; c--;)
                    if (s = Je.exec(t[c]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (f = de.event.special[p] || {}, p = (r ? f.delegateType : f.bindType) || p, d = u[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;) l = d[o], !i && g !== l.origType || n && n.guid !== l.guid || s && !s.test(l.namespace) || r && r !== l.selector && ("**" !== r || !l.selector) || (d.splice(o, 1), l.selector && d.delegateCount--, f.remove && f.remove.call(e, l));
                        a && !d.length && (f.teardown && f.teardown.call(e, h, m.handle) !== !1 || de.removeEvent(e, p, m.handle), delete u[p])
                    } else
                        for (p in u) de.event.remove(e, p + t[c], n, r, !0);
            ...
            if (s.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, s) !== !1) {
                for (a = de.event.handlers.call(this, s, c), t = 0;
                    ...
                    for (s.currentTarget = i.elem, n = 0;
                        (o = i.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !s.rnamespace.test(o.namespace) || (s.handleObj = o, s.data = o.data, r = ((de.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, u), void 0 !== r && (s.result = r) === !1 && (s.preventDefault(), s.stopPropagation()));
    ...
    de.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(le.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || de.isXMLDoc(e)))
                for (a = m(s), o = m(e), r = 0, i = o.length; r < i; r++) E(o[r], a[r]);
            if (t)
                if (n)
                    for (o = o || m(e), a = a || m(s), r = 0, i = o.length; r < i; r++) A(o[r], a[r]);
                else A(e, s);
        ...
        de.fn[e] = function(e) {
            for (var n, r = [], i = de(e), o = i.length - 1, a = 0; a <= o; a++) n = a === o ? this : this.clone(!0), de(i[a])[t](n), re.apply(r, n.get());
    ...
    ! function() {
        ...
        s.style && (s.style.backgroundClip = "content-box", s.cloneNode(!0).style.backgroundClip = "", le.clearCloneStyle = "content-box" === s.style.backgroundClip, a.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", a.appendChild(s), de.extend(le, {
    ...
    de.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = de.camelCase(t),
                    u = e.style;
                return t = de.cssProps[s] || (de.cssProps[s] = _(s) || s), a = de.cssHooks[t] || de.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Pe.exec(n)) && i[1] && (n = p(e, t, i), o = "number"), void(null != n && n === n && ("number" === o && (n += i && i[3] || (de.cssNumber[s] ? "" : "px")), le.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n))))
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = de.camelCase(t);
            return t = de.cssProps[s] || (de.cssProps[s] = _(s) || s), a = de.cssHooks[t] || de.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = L(e, t, r)), "normal" === i && t in ut && (i = ut[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
        }
    }), de.each(["height", "width"], function(e, t) {
        de.cssHooks[t] = {
            get: function(e, n, r) {
                if (n) return !at.test(de.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? H(e, t, r) : Me(e, st, function() {
                    return H(e, t, r)
                })
            },
            set: function(e, n, r) {
                var i, o = r && ot(e),
                    a = r && q(e, t, r, "border-box" === de.css(e, "boxSizing", !1, o), o);
                return a && (i = Pe.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = de.css(e, t)), O(e, n, a)
            }
        }
    }), de.cssHooks.marginLeft = j(le.reliableMarginLeft, function(e, t) {
        if (t) return (parseFloat(L(e, "marginLeft")) || e.getBoundingClientRect().left - Me(e, {
            marginLeft: 0
        }, function() {
        ...
        }, rt.test(e) || (de.cssHooks[e + t].set = O)
    }), de.fn.extend({
        css: function(e, t) {
        ...
        run: function(e) {
            ...
            return this.options.duration ? this.pos = t = de.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : $.propHooks._default.set(this), this
        }
    ...
    de.Animation = de.extend(B, {
            ...
            return de.fx.off || Z.hidden ? r.duration = 0 : r.duration = "number" == typeof r.duration ? r.duration : r.duration in de.fx.speeds ? de.fx.speeds[r.duration] : de.fx.speeds._default, null != r.queue && r.queue !== !0 || (r.queue = "fx"), r.old = r.complete, r.complete = function() {
            ...
            dt || (dt = e.requestAnimationFrame ? e.requestAnimationFrame(F) : e.setInterval(de.fx.tick, de.fx.interval))
        }, de.fx.stop = function() {
        ...
        function() {
            ...
            e.type = "checkbox", le.checkOn = "" !== e.value, le.optSelected = n.selected, e = Z.createElement("input"), e.value = "t", e.type = "radio", le.radioValue = "t" === e.value
        }();
    ...
    de.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : de.isFunction(e) ? this.each(function(n) {
                ...
                var t, r, i, o;
                if ("string" === n)
                    for (r = 0, i = de(this), o = e.match(Ne) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            ...
            select: {
                get: function(e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type, a = o ? null : [], s = o ? i + 1 : r.length, u = i < 0 ? s : o ? i : 0; u < s; u++)
                        if (n = r[u], (n.selected || u === i) && !n.disabled && (!n.parentNode.disabled || !de.nodeName(n.parentNode, "optgroup"))) {
    ...
    de.extend(de.event, {
        trigger: function(t, n, r, i) {
            ...
            if (a = s = r = r || Z, 3 !== r.nodeType && 8 !== r.nodeType && !Ct.test(p + de.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[de.expando] ? t : new de.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : de.makeArray(n, [t]), f = de.event.special[p] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !de.isWindow(r)) {
                    for (u = f.delegateType || p, Ct.test(u + p) || (a = a.parentNode); a; a = a.parentNode) d.push(a), s = a;
                    s === (r.ownerDocument || Z) && d.push(s.defaultView || s.parentWindow || e)
                }
                for (o = 0;
                    (a = d[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || p, l = (Oe.get(a, "events") || {})[t.type] && Oe.get(a, "handle"), l && l.apply(a, n), l = c && a[c], l && l.apply && _e(a) && (t.result = l.apply(a, n), t.result === !1 && t.preventDefault());
                return t.type = p, i || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !_e(r) || c && de.isFunction(r[p]) && !de.isWindow(r) && (s = r[c], s && (r[c] = null), de.event.triggered = p, r[p](), de.event.triggered = void 0, s && (r[c] = s)), t.result
            }
        },
    ...
    }), le.focusin = "onfocusin" in e, le.focusin || de.each({
        focus: "focusin",
        blur: "focusout"
    }, function(e, t) {
        var n = function(e) {
    ...
    de.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !de(this).is(":disabled") && Dt.test(this.nodeName) && !Nt.test(e) && (this.checked || !Be.test(e))
            }).map(function(e, t) {
                var n = de(this).val();
    ...
    It.href = Tt.href, de.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, s) {
                var c, d, p, b, w, C = n;
                l || (l = !0, u && e.clearTimeout(u), i = void 0, a = s || "", T.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, r && (b = Y(h, T, r)), b = G(h, b, T, c), c ? (h.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (de.lastModified[o] = w), w = T.getResponseHeader("etag"), w && (de.etag[o] = w)), 204 === t || "HEAD" === h.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = b.state, d = b.data, p = b.error, c = !p)) : (p = C, !t && C || (C = "error", t < 0 && (t = 0))), T.status = t, T.statusText = (n || C) + "", c ? v.resolveWith(g, [d, C, T]) : v.rejectWith(g, [T, C, p]), T.statusCode(x), x = void 0, f && m.trigger(c ? "ajaxSuccess" : "ajaxError", [T, h, c ? d : p]), y.fireWith(g, [T, C]), f && (m.trigger("ajaxComplete", [T, h]), --de.active || de.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t, t = void 0), n = n || {};
            var i, o, a, s, u, c, l, f, d, p, h = de.ajaxSetup({}, n),
                g = h.context || h,
            ...
            if (v.promise(T), h.url = ((t || h.url || Tt.href) + "").replace($t, Tt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Ne) || [""], null == h.crossDomain) {
                c = Z.createElement("a");
                try {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = de.param(h.data, h.traditional)), V(Ft, h, n, T), l) return T;
            f = de.event && h.global, f && 0 === de.active++ && de.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ht.test(h.type), o = h.url.replace(jt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Lt, "+")) : (p = h.url.slice(o.length), h.data && (o += (St.test(o) ? "&" : "?") + h.data, delete h.data), h.cache === !1 && (o = o.replace(_t, ""), p = (St.test(o) ? "&" : "?") + "_=" + kt++ + p), h.url = o + p), h.ifModified && (de.lastModified[o] && T.setRequestHeader("If-Modified-Since", de.lastModified[o]), de.etag[o] && T.setRequestHeader("If-None-Match", de.etag[o])), (h.data && h.hasContent && h.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", h.contentType), T.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Rt + "; q=0.01" : "") : h.accepts["*"]);
            for (d in h.headers) T.setRequestHeader(d, h.headers[d]);
            if (h.beforeSend && (h.beforeSend.call(g, T, h) === !1 || l)) return T.abort();
            if (C = "abort", y.add(h.complete), T.done(h.success), T.fail(h.error), i = V(Pt, h, n, T)) {
    ...
    le.cors = !!Wt && "withCredentials" in Wt, le.ajax = Wt = !!Wt, de.ajaxTransport(function(t) {
        var n, r;
        if (le.cors || Wt && !t.crossDomain) return {
            send: function(i, o) {
                var a, s = t.xhr();
    ...
    de.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = de.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(zt, "$1" + i) : t.jsonp !== !1 && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
        ...
        var r, i, o;
        return t || (le.createHTMLDocument ? (t = Z.implementation.createHTMLDocument(""), r = t.createElement("base"), r.href = Z.location.href, t.head.appendChild(r)) : t = Z), i = we.exec(e), o = !n && [], i ? [t.createElement(i[1])] : (i = y([e], t, o), o && o.length && de(o).remove(), de.merge([], i.childNodes))
        ...
        setOffset: function(e, t, n) {
            var r, i, o, a, s, u, c, l = de.css(e, "position"),
                f = de(e),
                d = {};
            "static" === l && (e.style.position = "relative"), s = f.offset(), o = de.css(e, "top"), u = de.css(e, "left"), c = ("absolute" === l || "fixed" === l) && (o + u).indexOf("auto") > -1, c ? (r = f.position(), a = r.top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), de.isFunction(t) && (t = t.call(e, n, de.extend({}, s))), null != t.top && (d.top = t.top - s.top + a), null != t.left && (d.left = t.left - s.left + i), "using" in t ? t.using.call(e, d) : f.css(d)
        }
    }, de.fn.extend({
        offset: function(e) {
        ...
        de.cssHooks[t] = j(le.pixelPosition, function(e, n) {
    ...
    return de.noConflict = function(t) {
        return e.$ === de && (e.$ = Xt), t && e.jQuery === de && (e.jQuery = Ut), de
    }, t || (e.jQuery = e.$ = de), de
}), ! function(e, t, n, r) {
    var i = e(t);
...
$(document).ready(function() {
    $(".echOL_stg_01 .msg1CntBtn").click(function() {
        $(".echOL_stg_01").fadeOut(), $(".echOL_stg_02").delay(500).fadeIn(), $(".echOL_stg_02").delay(1e3).fadeOut(), $(".echOL_stg_03").delay(2e3).fadeIn(), remClass(), $("body").addClass("clckStg_03")
    }), $(".echOL_stg_03 .btnStyle_3").click(function() {
        $(".echOL_stg_03").fadeOut(), $(".echOL_stg_04").delay(500).fadeIn(), remClass(), $("body").addClass("clckStg_04")
    }), $(".echOL_stg_04 .btnStyle_3").click(function() {
        $(".echOL_stg_04").fadeOut(), $(".echOL_stg_05").delay(500).fadeIn(), remClass(), $("body").addClass("clckStg_05")
    }), $(".echOL_stg_05 .btnStyle_3").click(function() {
        $(".echOL_stg_05").fadeOut(), $(".echOL_stg_06").delay(500).fadeIn(), remClass(), $("body").addClass("clckStg_06")
    }), $(".echOL_stg_06 .btnStyle_3").click(function() {
        $(".echOL_stg_06").fadeOut(), $(".echOL_stg_07").delay(500).fadeIn(), remClass(), $("body").addClass("clckStg_07")
    }), $(".echOL_stg_07 .btnStyle_2").click(function() {
        $(".echOL_stg_07").fadeOut(), $(".echOL_stg_08").delay(500).fadeIn(), remClass(), $("body").addClass("clckStg_08"), countClick = 0
    }), $(".echOL_stg_08 .btnStyle_2").click(function() {
        $(".echOL_stg_08").fadeOut(), $(".echOL_stg_09").delay(500).fadeIn(), remClass(), $("body").addClass("clckStg_09"), countClick = 0
    }), $(".echOL_stg_09 .btnStyle_2").click(function() {
        $(".echOL_stg_09").fadeOut(), $(".echOL_stg_10").delay(500).fadeIn(), remClass(), $("body").addClass("clckStg_10"), countClick = 2
    }), $(".echOL_stg_10 .btnStyle_2").click(function() {
        $(".echOL_stg_10").fadeOut(), $(".echOL_stg_11").delay(500).fadeIn(), remClass(), $("body").addClass("clckStg_11"), countClick = 0
    }), $(".oltOvrLy_cnt_opt_Ech_ib").click(function() {
        if ($(this).hasClass("tickAct")) countClick--, $(this).removeClass("tickAct");
        else {
            if (maxTicks = $(this).hasClass("oltOvrLy_cnt_opt_Ech_ib_Single") ? 1 : 3, countClick++, countClick > maxTicks) return countClick = maxTicks, !1;
            $(this).addClass("tickAct")
        }
    })
});